...
confMa.train.naive.loss = table(train$good_bad, ifelse(
                          naive.train.raw[,1]/naive.train.raw[,2] > 10, "bad", "good"))
...
Firstly, what can be seen is that the missclassification rate with the loss matrix are lower than without it. The reason for this is that the loss matrix helps the model learn what is more "costly" to the function and what isn't.
