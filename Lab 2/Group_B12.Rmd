...
The table for the confusion matrix of the test data for the Naive Bayes model: 
...
```
When comparing these traceplots to the traceplots of step 2, the traceplot of W’ Col 2 is very similar to the plot of PC2 with inverted y-axis.
